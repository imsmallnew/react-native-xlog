 ...
 */
+ (void)registerWithLogPath:(NSString *_Nullable)logPath level:(TLogLevel)level showConsoleLog:(BOOL)showConsoleLog appenderMode:(mars::xlog::TAppenderMode)mode nameprefix:(NSString *)nameprefix;
